...
<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "Sharity" is a dedicated application developed for the members of JCI Batangas-Balisong. This app empowers members to efficiently manage the organization's projects and activities, When members log in to Sharity, they can access a user-friendly that provides a comprehensive view of all ongoing and completed projects. while the dashboard not only displays project details but also includes information about donations received for each project.</p>
